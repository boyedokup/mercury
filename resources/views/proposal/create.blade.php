...
<div class="col-md-6 col-md-offset-3 col-sm-12">
                ...
                <div class="card-content">
                    ...
                    <h5 class='blue-text text-center'>Create Proposal</h5>
                   {!! Form::open(array('url' => 'proposal','method'=>'post','files'=>'true')) !!}
                       {!! Form::token() !!}
                ...
                <div class='input-field'>
                   {!! Form::text('funding') !!}
                <label for="funding">Funding:<span class='red-text text-darken-1'>{{$errors->first('funding')}}</span></label>
