    ...
    <div class="row text-center col-md-12">
         ...
         <div class="col-md-12">
            <div class="card-panel blue">
                <span class="white-text"> These are applications you have submitted.
          </span>
            </div>
        </div>
    ...
    <div class="col-md-3 col-sm-12 col-xs-12">
        ...
        <ul class="nav nav-tabs md-pills pills-primary" role="tablist">
            <li class="nav-item active">
                <a class="nav-link" data-toggle="tab" href="#panel21" role="tab"> Submitted Proposal</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" data-toggle="tab" href="#panel22" role="tab">Submitted Tender</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" data-toggle="tab" href="#panel23" role="tab">Submitted Quotation</a>
            </li>
        </ul>
    </div>
    ...
    <div class="col-md-9 col-sm-12 col-xs-12">
        ...
        <div class="tab-content vertical">
           ...
           @if(count($proposals)==0)
               <h5>No Proposal Application submitted yet </h5>
               @endif
       ...
       <?php $countp++ ?>
        ...
        @endforeach
            ...
            <div class="tab-pane fade" id="panel22" role="tabpanel">
                  ...
                  @if(count($tenders)==0)
               <h5>No Tender Application submitted yet </h5>
               @endif
       ...
       <?php $countt++ ?>
        ...
        @endforeach
            ...
            <div class="tab-pane fade" id="panel23" role="tabpanel">
               ...
               <h5>No Quotation Application submitted yet </h5>
               @endif
