...
@section('content')
<div class='row' ng-app='edit_quotation' ng-controller='QuotationCtrl'>
<div class="col-md-6 col-md-offset-3 col-sm-12">
                ...
                <div class="card-content">
                  <a href="{{ URL::previous() }}" class=''><i class="fa fa-arrow-left fa-2x" aria-hidden="true"></i></a>
                    ...
                    <h5 class='blue-text text-center'>Update Quotation</h5>
                    {!! Form::model($quotation, array('route' => array('quotation.update',$quotation->id),'method'=>'put','files'=>true)) !!}
                       {!! Form::token() !!}
                

                <div class='input-field'>
                   {!! Form::text('name') !!}
                <label for="name" >Quotation Name:<span class='red-text text-darken-1'>{{$errors->first('quotation_name')}}</span></label>
               
                </div>


                <div class='input-field'>
                {!!Form::textarea('scope_description',$quotation->submission_closing_date,["class"=>"materialize-textarea"])!!}
               ...
               <div class='input-field'>
                ...
                <label for="documents">Required Documents from Applicants:<span class='red-text text-darken-1'>{{$errors->first('documents')}}</span></label>
                 ...
                 <div class='input-field'>
                 {!!Form::date('submission_closing_date',null,['class'=>'datepicker'])!!}
...
<!-- /.Live preview-->
  ...
  <script type="text/javascript">
   ...
   var app = angular.module('edit_quotation', [], function($interpolateProvider) {
